...
const getContent = (type: MilestoneIconType) => {
  ...
  switch (type) {
    ...
    default:
      result = (
        <path
          d="M11.0858 23.5858L1.91422 14.4142C1.13317 13.6332 1.13317 12.3668 1.91422 11.5858L11.0858 2.41421C11.8669 1.63316 13.1332 1.63317 13.9142 2.41421L23.0858 11.5858C23.8669 12.3668 23.8669 13.6332 23.0858 14.4142L13.9142 23.5858C13.1332 24.3668 11.8669 24.3668 11.0858 23.5858Z"
          fill="white"
          stroke="#7F869F"
          strokeWidth="2"
        />
