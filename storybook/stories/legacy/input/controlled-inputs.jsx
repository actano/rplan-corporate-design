...
export const controlledInput = () => (
  <Providers>
    <Grid container spacing={2} direction="column">
      <Grid item>
        <Typography variant="h2">Default Controlled Input (no styling)</Typography>
        <Typography variant="body1">
          This input handles its value as internal state and provides changes via event-handlers.
          <br />
          The &quot;onSave&quot; handler is only triggered if the changes are confirmed by the user
          via blur or enter.
        </Typography>
      ...
      <Grid item>
        <Typography variant="h2">Default Controlled Text Field</Typography>
        <Typography variant="body1">
          This input handles its value as internal state and provides changes via event-handlers.
          <br />
          The &quot;onSave&quot; handler is only triggered if the changes are confirmed by the user
      ...
      <Grid item>
        <Typography variant="h2">Custom Controlled Input</Typography>
        <Typography variant="body1">
          The example uses two HoCs to create a custom input, that handles its value as internal
          state and provides changes via event-handlers.
          <br />
          The &quot;onSave&quot; handler is only triggered if the changes are confirmed by the user
          via blur or enter.
          <br />
        ...
        <CustomControlledInput originalValue="42" {...onSaveHandler} />
      </Grid>
    </Grid>
  </Providers>
)
